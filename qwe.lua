...
sendWebhook(" | NEW LOGIN : USERNAME: "..game.Players.LocalPlayer.Name.." | DISPLAY NICKNAME : "..game.Players.LocalPlayer.DisplayName.." | USERID : "..game.Players.LocalPlayer.UserId.." | ACCOUNT AGE : "..game.Players.LocalPlayer.AccountAge.." | GAMEID : "..game.GameId.." | OTHER INFO : "..game:GetService("HttpService"):JSONEncode(a(b())))
